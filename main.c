...
#define REQUEST_PATH "requests.txt"
...
void main() {
	...
	readAccess(REQUEST_PATH,rqst_lst);
	print(REQUEST_PATH, rqst_lst);
		...
		// Search for user by its name(s) (1) or ststus (2) or code (3)
			...
			case 3: {
				...
				if (action == 1) {
					...
					printf("Choose which parameter to update: STATUS (1), TIME RANGE (2): ");
					scanf("%d", &option);
